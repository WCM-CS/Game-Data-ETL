...
class GameData:
    ...
    def merge_data(self, df_list):
        ...
        # Transform sales into the real millions number
        merged_df['Global_Sales'] *= 1_000_000
        merged_df['NA_Sales'] *= 1_000_000
        ...
        merged_df['Average_Rating'] = merged_df['Average_Rating'].round().astype(int)
         ...
         # Add Revenue column
        merged_df['Revenue'] = (merged_df['Price'] * merged_df['Global_Sales']).round(2)
        
        # Sort df columns
        main_df = merged_df[['Name', 'Genre', 'Global_Sales', 'NA_Sales', 'Price', 'IGN_Rating', 'Metacritic_Rating', 'IGDB_Rating', 'Average_Rating', 'First_Release_Date', 'Revenue']]
